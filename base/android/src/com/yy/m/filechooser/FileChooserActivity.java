...
public class FileChooserActivity extends FragmentActivity implements
	...
	private void addFragment(String path) {
		FileListFragment explorerFragment = FileListFragment.newInstance(path, this.getIntent().getStringExtra("filter"));
	...
	private void finishWithResult(File file) {
		if (file != null) {
			...
			result.setData(uri);
			result.putExtra("callback", this.getIntent().getStringExtra("callback"));
