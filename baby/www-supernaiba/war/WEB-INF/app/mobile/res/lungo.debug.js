...
Lungo.Element.Carousel = function(element, callback) {
    ...
    var prev = function(delay) {
    	var index = _instance.index ==0 ?  _instance.slides_length - 1 : _instance.index-1;
    ...
    var _slide = function(index, duration) {
    	if(index>=_instance.slides_length && index)
    		index=_instance.slides_length-1
